...
def get_activations(images, sess, batch_size=50, verbose=False):
    ...
    if batch_size > n_images:
        ...
        batch_size = n_images
    n_batches = n_batches = n_images//batch_size + int( n_images % batch_size > 0 )#n_images//batch_size
    ...
    for i in range(n_batches):
        ...
        pred_arr[start:end] = pred.reshape(batch.shape[0],-1) #pred_arr[start:end] = pred.reshape(batch_size,-1)
    if verbose:
        print(" done")
    return pred_arr
#-------------------------------------------------------------------------------
